<div class="col-12">
    <div class="row">
        ...
        <div class="col-6 d-flex justify-content-end">
            @if ($documentfile->last_updated_by_id == auth()->user()->id && $checkAllActionsQualityScan == true)
                <div class="mr-2">
                    <form action="{{ route('quality-scan.document-file.changeStatus', $documentfile->id) }}" method="post">
